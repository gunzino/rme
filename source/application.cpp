...
{
	// wxIMPLEMENT_APP provides the app initializer; wxEntry runs init + main loop + cleanup.
	// Calling wxEntryStart followed by wxEntry() would initialize wxWidgets twice.
