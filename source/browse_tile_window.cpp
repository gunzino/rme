...
wxDialog(parent, wxID_ANY, "Browse Field", position, wxSize(600, 400), wxCAPTION | wxCLOSE_BOX | wxRESIZE_BORDER)
{
	...
	infoSizer->Add(newd wxStaticText(this, wxID_ANY, "Hardcore-PvP zone:  " + b2yn(tile->getMapFlags() & TILESTATE_HARDCORE_PVP)), wxSizerFlags(0).Left());
	infoSizer->Add(newd wxStaticText(this, wxID_ANY, "Resting zone:  " + b2yn(tile->getMapFlags() & TILESTATE_RESTINGAREAZONE)), wxSizerFlags(0).Left());
