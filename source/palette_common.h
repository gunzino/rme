...
public:
	...
	void OnClickHardcorePVPZoneBrushButton(wxCommandEvent& event);
	void OnClickRestingZoneBrushButton(wxCommandEvent& event);
public:
	void DeselectAll();
	...
	BrushButton* hardcorepvpBrushButton;
	BrushButton* restingzoneBrushButton;
