...
MainToolBar::MainToolBar(wxWindow* parent, wxAuiManager* manager)
{
	...
	brushes_toolbar->AddTool(PALETTE_TERRAIN_HARDCOREPVP_TOOL, wxEmptyString, pvp_bitmap, wxNullBitmap, wxITEM_CHECK, "Hardcore-PvP Zone", wxEmptyString, NULL);
	brushes_toolbar->AddTool(PALETTE_TERRAIN_RESTINGZONE_TOOL, wxEmptyString, nopvp_bitmap, wxNullBitmap, wxITEM_CHECK, "Resting area Zone", wxEmptyString, NULL);
	brushes_toolbar->AddSeparator();
...
void MainToolBar::UpdateButtons()
{
	...
	brushes_toolbar->EnableTool(PALETTE_TERRAIN_HARDCOREPVP_TOOL, has_map);
	brushes_toolbar->EnableTool(PALETTE_TERRAIN_RESTINGZONE_TOOL, has_map);
...
void MainToolBar::UpdateBrushButtons()
{
	...
	if(brush) {
		...
		brushes_toolbar->ToggleTool(PALETTE_TERRAIN_HARDCOREPVP_TOOL, brush == g_gui.hardcore_pvp_brush);
		brushes_toolbar->ToggleTool(PALETTE_TERRAIN_RESTINGZONE_TOOL, brush == g_gui.resting_zone_brush);
		...
		brushes_toolbar->ToggleTool(PALETTE_TERRAIN_HARDCOREPVP_TOOL, false);
		brushes_toolbar->ToggleTool(PALETTE_TERRAIN_RESTINGZONE_TOOL, false);
...
void MainToolBar::OnBrushesButtonClick(wxCommandEvent& event)
{
	...
	switch (event.GetId()) {
		...
		case PALETTE_TERRAIN_PVPZONE_TOOL:
			...
			break;
		case PALETTE_TERRAIN_HARDCOREPVP_TOOL:
			g_gui.SelectBrush(g_gui.hardcore_pvp_brush);
			break;
		case PALETTE_TERRAIN_RESTINGZONE_TOOL:
